...
source_file_loc = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\OneDrive_2023-03-14\010423_031223_Heap_Demo_Requests.xlsx")
ext_file_location = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\Extracted\010423_031223_Heap_Demo_Requests_updated.csv")
...
df.columns=['UTM_MEDIUM_HDR', 'UTM_SOURCE_HDR', 'UTM_CAMPAIGN_HDR', 'UTM_CONTENT_HDR', 'DEMO_REQUESTS_HDR']
...
df.to_sql('heap_demo_requests', engine, if_exists='replace', index=False, index_label=None, chunksize=None, dtype=None, method=None) 
connection.close()
engine.dispose()
