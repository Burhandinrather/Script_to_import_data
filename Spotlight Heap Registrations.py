...
source_file_loc = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\OneDrive_2023-03-14\022723_031223_WHL_SD_Heap_Registration_Page_Sessions.xlsx")
ext_file_location = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\Extracted\022723_031223_WHL_SD_Heap_Registration_Page_Sessions_updated.csv")
...
df.columns=['UTM_CAMPAIGN_SHR', 'UTM_SOURCE_SHR',  'UTM_MEDIUM_SHR', 'UTM_CONTENT_SHR','UTM_REGISTRATIONS_SHR']
...
df.to_sql('spotlight_heap_registrations', engine, if_exists='replace', index=False, index_label=None, chunksize=None, dtype=None, method=None) 
connection.close()
engine.dispose()
