...
source_file_loc = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\OneDrive_2023-03-14\010423_031223_Evergreen_Heap_Registration_Page_Sessions.xlsx.xlsx")
ext_file_location = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\Extracted\010423_031223_Evergreen_Heap_Registration_Page_Sessions_updated.csv")
...
df.columns=['UTM_CAMPAIGN_EHRPS',  'UTM_SOURCE_EHRPS', 'UTM_MEDIUM_EHRPS', 'UTM_CONTENT_EHRPS','UTM_REGISTRATIONS_EHRPS' ]
...
df.to_sql('evergreen_heap_registrations_page_sessions', engine, if_exists='replace', index=False, index_label=None, chunksize=None, dtype=None, method=None) 
connection.close()
engine.dispose()
