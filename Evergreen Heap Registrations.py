...
source_file_loc = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\OneDrive_2023-03-14\010423_031223_Evergreen_Heap_Registrations.xlsx.xlsx")
ext_file_location = (r"C:\Work\Workhuman\2023\Q1\Lloyd\Source\Round 4\Extracted\010423_031223_Evergreen_Heap_Registrations.xlsx_updated.csv")
...
df.columns=['UTM_CAMPAIGN_EHR', 'UTM_SOURCE_EHR',  'UTM_MEDIUM_EHR', 'UTM_CONTENT_EHR','UTM_REGISTRATIONS_EHR']
...
df.to_sql('evergreen_heap_registrations', engine, if_exists='replace', index=False, index_label=None, chunksize=None, dtype=None, method=None) 
connection.close()
engine.dispose()
